 ...
 * @author USER
 */
public class DeleteControllerT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            String id = request.getParameter("delTool");
            ToolBeans beans = new ToolBeans();
            beans.setId(id);
            boolean check = beans.deleteToolAssigned();
            boolean status = beans.deleteTool();
            ...
            log("ERROR at DeleteControllerTool: " + e.getMessage());
        }
        finally
        {
