...
public class UpdateControllerS extends HttpServlet {
    ...
    private static final String INVALID = "updatescene.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("txtIdd");
        ...
        try {
            ...
            if (!valid) {
                ...
                String startDate = request.getParameter("txtDate") + "/" + request.getParameter("txtMonth") + "/" + request.getParameter("txtYear");
                String endDate = request.getParameter("txtDateE") + "/" + request.getParameter("txtMonthE") + "/" + request.getParameter("txtYearE");
            ...
            {
                log("ERROR at UpdateCotrollerS: " + e.getMessage());
            }
