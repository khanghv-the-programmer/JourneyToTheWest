<%-- 
    ...
    Created on : Jun 30, 4, 5:54:02 PM
    Author     : USER
--%>
...
<html>
    ...
    <body style="background-image: url(https://img.8wallpapers.com/uploads/2018/09/a348b7f275a140119d11b3d1.jpg); background-size: cover">
        <h1 style="color: red; font-size: 40px;border-radius:12px; text-align: center">Update Scene</h1>
        ...
        <form action="MainControllerS" method="POST" style="width: 800px; height: 900px; background-color: white; padding: 80px; font-size: 25px; font-family: sans-serif; margin: 100px">
            ID : <input type="text" name="txtIdd" value="${requestScope.DTO.id}${requestScope.ID}" readonly="true" /><br/><br/>
        Name: <input type="text" name="txtSName" value="${requestScope.DTO.name}${requestScope.NAME}" /><br/>
        <font color="red">${requestScope.INVALID.nameError}</font><br/>
        Description: <input type="text" name="txtSDesc" value="${requestScope.DTO.desc}${requestScope.DESC}" /><br/>
        <font color="red">${requestScope.INVALID.descError}</font><br/>
        Location: <input type="text" name="txtSLoc" value="${requestScope.DTO.location}${requestScope.LOC}" /><br/>
        ...
        Time Takes: <input type="text" name="txtTake" value="${requestScope.DTO.take}${requestScope.TAKE}" /><br/>
