<%-- 
    Document   : viewupcoming
    Created on : Jul 11, 2020, 3:41:19 PM
    Author     : USER
--%>
...
<html>
    ...
    <body style="background-image: url(https://img.8wallpapers.com/uploads/2018/09/a348b7f275a140119d11b3d1.jpg); background-size: cover">
        <h1 style="color: #e84a5f; font-size: 5em">View Upcoming Scene</h1>
        ...
        <c:if test="${requestScope.UPCOMING != null}">
            <c:if test="${not empty requestScope.UPCOMING}" var="isNotEmpty">
                <table border="1" style="background-color: white">
                    <thead>
                        <tr>
                            ...
                            <th style="font-size: 18px; text-align: center">Takes (In Expectation)</th>
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.UPCOMING}" var="dto" varStatus="counter">
                            <tr>
            ...
            <c:if test="${!isNotEmpty}">
                <h2><font color="blue" style="font-size: 30px; background-color: white">Hmmm...Looks like you don't have any schedule</font></h2>
                </c:if>
            </c:if>
    </body>
</html>
